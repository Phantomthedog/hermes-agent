...
def init_agent(
    ...
    if agent.api_mode == "anthropic_messages":
        ...
        if api_key and base_url:
            ...
            elif base_url_host_matches(effective_base, "allrouter.xyz"):
                from agent.auxiliary_client import build_allrouter_headers
                client_kwargs["default_headers"] = build_allrouter_headers()
    ...
    agent._owns_context_engine: bool = False
